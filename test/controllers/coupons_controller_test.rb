...
class CouponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post coupons_url, params: { coupon: { code: @coupon.code, coupon_count: @coupon.coupon_count, percentage: @coupon.percentage, screen_id: @coupon.screen_id } }
    end
  ...
  test "should update coupon" do
    patch coupon_url(@coupon), params: { coupon: { code: @coupon.code, coupon_count: @coupon.coupon_count, percentage: @coupon.percentage, screen_id: @coupon.screen_id } }
